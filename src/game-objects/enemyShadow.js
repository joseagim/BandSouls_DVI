 ...
 */
export default class EnemyShadow extends Enemy {
    ...
    constructor(scene, x, y, stats) {
        ...
        this.scene.anims.create({
            key : 'shadow_move',
            frames: this.anims.generateFrameNames('shadow_move',{ prefix: 'move-', start: 1, end: 9 } ),
            frameRate: 10,
            repeat : -1
        });

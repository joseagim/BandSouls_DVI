...
import BossProjectile from './bossBeethovenProjectile';
...
export default class EnemyBeethoven extends Enemy {
    ...
    constructor(scene, x, y, stats) {
        ...
        this.collisionDamage = stats.collisionDamage ?? 10;
        ...
        if (this.body.setPushable) this.body.setPushable(false);
    ...
    spawn(_x, _y) {
        ...
        // Asegurar que el boss es inamovible tras el spawn
        this.body.setImmovable(true);
        if (this.body.setPushable) this.body.setPushable(false);
    ...
    /** Ataque por contacto: el boss hace daño al jugador si este lo toca. */
    attack(player) {
